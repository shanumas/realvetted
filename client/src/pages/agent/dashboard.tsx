  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        {/* Verification Warning for Non-Verified Agents */}
        {user && user.profileStatus !== "verified" && (
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-sm text-yellow-700 mb-3">
                  Your agent account is pending verification. Once verified, you'll have full access to all features.
                </p>
                <p className="text-sm text-yellow-700 mb-3">
                  To expedite the verification process, please contact our team:
                </p>
                <div className="flex items-center space-x-4">
                  <Button 
                    variant="outline" 
                    size="sm"
                    onClick={() => window.open('mailto:support@realvetted.com?subject=Agent Account Verification - Expedite Request&body=Hello RealVetted Team,%0D%0A%0D%0AI am requesting expedited verification for my agent account. My details:%0D%0A%0D%0AName: ' + encodeURIComponent(`${user.firstName || ''} ${user.lastName || ''}`.trim() || user.email) + '%0D%0AEmail: ' + encodeURIComponent(user.email) + '%0D%0ALicense Number: ' + encodeURIComponent(user.licenseNumber || 'Not provided') + '%0D%0A%0D%0APlease let me know if you need any additional information.%0D%0A%0D%0AThank you!')}
