...
// Using require instead of import to avoid TypeScript import issues
const { getRealtorUrlFromAnyRealEstateUrl } = require('./server/scrapers/serpapi-extractor');
const { extractPropertyFromUrl } = require('./server/extraction');
