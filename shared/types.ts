...
export interface PropertyAIData {
  ...
  listedbyName?: string; // Name of the listing agent
  listedbyEmail?: string; // Email of the listing agent
  listedbyPhone?: string; // Phone number of the listing agent
  listedbyCompany?: string; // Real estate company of the listing agent
  listedbyLicenseNo?: string; // License number of the listing agent
  // Property details
